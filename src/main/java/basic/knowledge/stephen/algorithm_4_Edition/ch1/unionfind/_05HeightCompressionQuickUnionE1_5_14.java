...
public class _05HeightCompressionQuickUnionE1_5_14 {
    private int count;
    private int[] ids;
    private int[] treeHeight;


    public _05HeightCompressionQuickUnionE1_5_14(int count) {
        this.count = count;
    ...
    public static void main(String[] args) {
        ...
        _05HeightCompressionQuickUnionE1_5_14 unionfind
                = new _05HeightCompressionQuickUnionE1_5_14(n);
