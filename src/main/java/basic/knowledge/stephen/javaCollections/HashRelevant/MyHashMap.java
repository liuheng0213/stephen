package basic.knowledge.stephen.javaCollections.HashRelevant;
...
public class MyHashMap {
    ...
    //this is very important    real one is transient Entry[] table
    //可以说Hashmap的底层是entry 数组
    //本质上是操作这个entry数组
    ...
    //就是咋iHashEntry[] table中添加一个entry<key,value>，或者找到这这个entry修改v
    ...
    private void add(int index, Object key, Object value) {
        ...
        HashEntry entry = new HashEntry(key, value, table[index+1]);
        table[index] = entry;
