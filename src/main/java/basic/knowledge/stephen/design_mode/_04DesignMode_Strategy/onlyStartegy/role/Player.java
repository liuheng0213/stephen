package basic.knowledge.stephen.design_mode._04DesignMode_Strategy.onlyStartegy.role;
...
public class Player {
    ...
    private CalPrice calPrice = (CalPrice) new Orgnic();//每个客户都有一个计算价格的策略，初始都是普通计算，即原价
